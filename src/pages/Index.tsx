...
const reviewsData = [
  ...
  { id: 2, name: 'Екатерина Скорикова', badge: 'Знаток города 6 уровня', date: '1 октября', avatar: 'Е', color: '#FF4800', opacity: 1, text: 'Ребятам даже не 5 звёзд, а 10. Почистили диван, которому уже лет 11, он как новый. Хотя, предупредили, что какие то пятна могут не вывести, но случилось чудо, и диван новый) Рекомендую...', top: '195px' },
  { id: 3, name: 'Екатерина Скорикова', badge: 'Знаток города 6 уровня', date: '1 октября', avatar: 'Е', color: '#1FD6A4', opacity: 0.6, text: 'Ребятам даже не 5 звёзд, а 10. Почистили диван, которому уже лет 11, он как новый. Хотя, предупредили, что какие то пятна могут не вывести, но случилось чудо, и диван новый) Рекомендую...', top: '404px' }
];
